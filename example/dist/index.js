...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Halogen.Modal.Utils"] = $PS["Halogen.Modal.Utils"] || {};
  var exports = $PS["Halogen.Modal.Utils"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];                
  var css = function ($0) {
...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Halogen.Modal"] = $PS["Halogen.Modal"] || {};
  var exports = $PS["Halogen.Modal"];
  ...
  var Halogen_Modal_Utils = $PS["Halogen.Modal.Utils"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var Receive = (function () {
  ...
  var component = function (dictMonadEffect) {
      var render = function (state) {
          var padding = function (size) {
              return CSS_Geometry.padding(CSS_Size.px(size))(CSS_Size.px(size))(CSS_Size.px(size))(CSS_Size.px(size));
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(0.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.pct(100.0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.vh(100.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.zIndex(99998))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color.black))(function () {
                                  if (state.isActive) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.display(CSS_Display.flex))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Flexbox.justifyContent(CSS_Flexbox.JustifyContentValue(CSS_Property.Value(new CSS_Property.Plain("center")))))(function () {
                                              return CSS_Flexbox.alignItems(CSS_Flexbox.AlignItemsValue(CSS_Property.Value(new CSS_Property.Plain("center"))));
                                          });
                                      });
                                  };
                                  if (!state.isActive) {
                                  ...
                                  throw new Error("Failed pattern match at Halogen.Modal (line 76, column 9 - line 85, column 47): " + [ state.isActive.constructor.name ]);
                              });
                          });
                      });
                  });
              });
          })), Halogen_Modal_Utils.css("modal-layer") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.zIndex(99999))(function () {
          ...
          })), Halogen_Modal_Utils.css("modal-container") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(0.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.right(CSS_Size.px(0.0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(25.0)))(function () {
                          return padding(8.0);
                      });
                  });
              });
          })), Halogen_Modal_Utils.css("modal-header"), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(CloseModal.value);
          }) ])([ Halogen_HTML_Core.text("X") ]), Halogen_HTML_Elements.div([ Halogen_Modal_Utils.css("modal-body") ])([ state.html ]) ]) ]);
      };
      var handleAction = function (v) {
          if (v instanceof Receive) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Effect_Class_Console.logShow(Effect_Class.monadEffectEffect)(Data_Show.showBoolean)(v.value0.isActive)))(function () {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $9.html = v.value0.html;
                      $9.isActive = v.value0.isActive;
                      return $9;
                  });
              });
          };
          if (v instanceof CloseModal) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Halogen.Modal (line 62, column 7 - line 64, column 50): " + [ v1.isActive.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Halogen.Modal (line 54, column 18 - line 64, column 50): " + [ v.constructor.name ]);
      };
...
(function($PS) {
  ...
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Events = $PS["Halogen.HTML.Events"];
  var Halogen_Modal = $PS["Halogen.Modal"];
  var Halogen_Modal_Utils = $PS["Halogen.Modal.Utils"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var ModalTrigger = (function () {
      ...
      ModalTrigger.value = new ModalTrigger();
      return ModalTrigger;
  })();
  var initialState = {
      modalActive: false
  ...
  var component = function (dictMonadEffect) {
      var render = function (state) {
          ...
          })), Halogen_Modal_Utils.css("modal-example") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(ModalTrigger.value);
          }) ])([ Halogen_HTML_Core.text("Click me") ]), Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "modal";
          }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Halogen_Modal.component(dictMonadEffect))({
              isActive: state.modalActive,
              html: Halogen_HTML_Elements.p([  ])([ Halogen_HTML_Core.text("wow what a nice modal you got there") ])
          })(Data_Void.absurd) ]);
      };
      var handleAction = function (v) {
          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
